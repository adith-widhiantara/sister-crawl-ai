    ...
    */
    ...
    'providers' => [
        ...
        'gemini' => [
            ...
            // ponytail: pin to 2.5-flash — the SDK's default (3.7-flash) is new/hot and kept
            // returning "provider overloaded". Bump if that settles down later.
            'models' => [
                'text' => [
        ...
        'openrouter' => [
            ...
            'models' => [
                'text' => [
                    // ponytail: fallback-only provider when gemini is overloaded, free tier is fine.
                    'default' => env('OPENROUTER_TEXT_MODEL', 'dots-studio/dots-3-note-preview:free'),
                ],
            ],
        ],
